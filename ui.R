...
ui <- fluidPage(theme = shinytheme("cosmo"),
  ...
  navbarPage(title = div("COVID-19 Dashboard", style = "padding-left: 10px"),
    ...
    navbarMenu("More", icon = icon("question-circle"),
               tabPanel(tags$a("", href = "https://github.com/jerrel-theos/Covid-19-Dashboard/", target = "_blank",list(icon("github"), "Resources"))),
               tabPanel(tags$a("", href = "https://www.linkedin.com/in/jerrel-audric-theos-18714a1a3", target = "_blank",list(icon("linkedin"), "My Profile"))),
    ...
    header.append('<div style=\"float:right\"><a target=\"_blank\" href=\"https://www.youtube.com/watch?v=cNcLxXbFEEA\"><img src=\"sample.jpg\" alt=\"alt\" style=\"float:right;width:33px;padding-top:10px;margin-top:-50px;margin-right:10px\"> </a></div>');
    console.log(header)")
    )
  )
)